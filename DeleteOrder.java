...
public class DeleteOrder extends Base {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElementByXPath("//a[@id='requesturl']").click();

		driver.findElementById("sysverb_delete").click();

		b.waitForVisibilityOfElement(By.id("ok_button"));
		driver.findElementById("ok_button").click();
		
		b.waitForVisibilityOfElement(By.xpath("//div[@class='notification notification-warning']"));
		String result = driver.findElementByXPath("//div[@class='notification notification-warning']").getText();
		
		if(result.contentEquals("Order: Empty"))
		{
